  ...
  return (
    <div className="m-40 grid">
      <div className="justify-self-center">
        ...
        <h1>입장</h1>
        <div>
          <input placeholder="server-name" className="border-2" type="text" onChange={(e) => setRoom(e.target.value)} />
        </div>
        <div>
          <input placeholder="user-name" className="border-2" type="text" onChange={(e) => setName(e.target.value)} />
        </div>
        <Link onClick={(e) => (!name || !room ? e.preventDefault() : null)} to={dir}>
