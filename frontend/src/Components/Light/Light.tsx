  ...
  return (
    <>
      ...
      <directionalLight
        ...
        position={[
          directionalControls.positionX,
          directionalControls.positionY,
          directionalControls.positionZ,
        ]}
      ...
      <pointLight
        ...
        position={[
          pointControls.positionX,
          pointControls.positionY,
          pointControls.positionZ,
        ]}
      ...
      <spotLight
        ...
        position={[
          spotControls.positionX,
          spotControls.positionY,
          spotControls.positionZ,
        ]}
